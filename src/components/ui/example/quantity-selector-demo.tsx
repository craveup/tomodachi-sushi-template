...
function QuantitySelector({ value, onChange, variant = "default", size = "md", showInput = true, min = 0, max = 99 }: QuantitySelectorProps) {
      ...
      <div className="inline-flex items-center border rounded-md">
        ...
        {showInput ? (
          <input
            type="number"
            value={value}
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => onChange(parseInt(e.target.value) || min)}
